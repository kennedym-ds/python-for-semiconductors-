"""
Validation script for Module 10.3 assessment (Documentation & Reproducibility).
"""
...
def validate_assessment_file(file_path):
    ...
    try:
        ...
        # Check module ID
        if data["module_id"] != "module-10.3":
            return False, f"Expected module_id 'module-10.3', got '{data['module_id']}'"
...
def main():
    """Validate Module 10.3 assessment file."""
    print("=" * 70)
    print("MODULE 10.3 ASSESSMENT VALIDATION")
    print("=" * 70)

    file_path = Path("assessments/module-10/10.3-questions.json")
