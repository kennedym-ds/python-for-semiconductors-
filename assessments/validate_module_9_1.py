"""
Validation script for Module 9.1 - MLOps Fundamentals
"""
import json
...
def validate_module_9_1():
    """Validate Module 9.1 questions file"""

    file_path = Path(__file__).parent / "module-9" / "9.1-questions.json"

    print("=" * 80)
    print("VALIDATING MODULE 9.1 - MLOps Fundamentals")
    print("=" * 80)
    ...
    if len(questions) != 25:
        print(f"✗ Expected 25 questions, found {len(questions)}")
        return False
    print("✓ Question count matches target (25)")

    # Validate question IDs
    expected_ids = [f"m9.1_q{i:03d}" for i in range(1, 26)]
    ...
    print("\n" + "=" * 80)
    print("✅ VALIDATION PASSED - Module 9.1")
    print("=" * 80)
    print(f"25 questions covering MLOps fundamentals")
    print(
