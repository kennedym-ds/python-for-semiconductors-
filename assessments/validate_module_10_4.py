"""
Validation script for Module 10.4 assessment (Scaling & Optimization).
"""
...
def validate_assessment_file(file_path):
    ...
    try:
        ...
        # Check module ID
        if data["module_id"] != "module-10.4":
            return False, f"Expected module_id 'module-10.4', got '{data['module_id']}'"
...
def main():
    """Validate Module 10.4 assessment file."""
    print("=" * 70)
    print("MODULE 10.4 ASSESSMENT VALIDATION")
    print("=" * 70)

    file_path = Path("assessments/module-10/10.4-questions.json")
