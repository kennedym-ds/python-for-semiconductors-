#!/usr/bin/env python3
"""Validate Module 6.1 assessment structure."""
...
def validate_module_6_1():
    """Validate Module 6.1 question bank."""

    file_path = Path("assessments/module-6/6.1-questions.json")
