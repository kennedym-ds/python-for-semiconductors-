...
def test_package_model_custom_name():
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        result = run_cmd([
            ...
            '--model-path', str(model_path),
            '--version', '1.5.0',
            '--output-name', 'my_custom_deployment'
        ])
...
def test_metadata_generation():
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        required_fields = [
            'model_name', 'version', 'created_at', 'model_type',
            'input_schema', 'output_schema', 'model_hash', 'deployment_config'
        ]
