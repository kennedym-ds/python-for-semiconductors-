...
class TestSyntheticDataGeneration(unittest.TestCase):
    ...
    def test_synthetic_data_generation(self):
        ...
        images, annotations = generate_synthetic_wafer_defects(
            n_images=3, image_size=(200, 200), n_defects_range=(1, 3), seed=42
        )
...
class TestClassicalDetector(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.images, self.annotations = generate_synthetic_wafer_defects(n_images=5, seed=42)
...
class TestPipelinePersistence(unittest.TestCase):
    ...
    def test_save_load_classical(self):
        ...
        pipeline = AdvancedDefectDetectionPipeline(backend="classical", blur_kernel=7, threshold_value=60)
