...
try:
    ...
    spec = importlib.util.spec_from_file_location(
        ...
        module_path / "6.1-deep-learning-pipeline.py"
    )
...
class TestDeepLearningPipeline:
    ...
    def test_evaluation_metrics(self):
        ...
        metrics = DeepLearningPipeline.compute_manufacturing_metrics(
            y_true, y_pred, task='regression', tolerance=0.2
        )
        ...
        metrics_clf = DeepLearningPipeline.compute_manufacturing_metrics(
            y_true_clf, y_pred_clf, task='classification'
        )
...
class TestCLIInterface:
    ...
    def test_cli_train_command(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            cmd = [
                'python', str(PIPELINE_SCRIPT), 'train',
    ...
    def test_cli_evaluate_command(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            eval_cmd = [
                'python', str(PIPELINE_SCRIPT), 'evaluate',
    ...
    def test_cli_predict_command(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            predict_cmd = [
                'python', str(PIPELINE_SCRIPT), 'predict',
                '--model-path', str(model_path),
    ...
    def test_regression_workflow(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            np.testing.assert_allclose(
                ...
                [loaded_metrics['mae'], loaded_metrics['rmse']], 
                rtol=1e-5
            )
